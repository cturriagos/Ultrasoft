...
namespace CapaPresentacion
{
    public partial class Proveedor_Actualizar : Form
    {
        ...
        private void Proveedor_Actualizar_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void actualizar()
        {
            ...
            comboBox3.DisplayMember = "Cod_Proveedor";
            comboBox3.ValueMember = "Cod_Proveedor";
            ...
            comboBox4.DisplayMember = "Nombre_Proveedor";
            comboBox4.ValueMember = "Nombre_Proveedor";
            textBox1.Text = Convert.ToString(comboBox4.SelectedValue);
            comboBox5.DataSource = obj.MostrarDatos(txtCodigoCliente.Text);
            comboBox5.DisplayMember = "Apellido_Proveedor";
            comboBox5.ValueMember = "Apellido_Proveedor";
